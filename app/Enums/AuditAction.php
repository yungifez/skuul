...
enum AuditAction: string
{
    ...
    /**
     * Reusable setup was copied into a new academic year.
     */
    case AcademicYearSetupRolledForward = 'academic_year.setup_rolled_forward';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::AcademicYearSetupRolledForward => 'Academic year setup rolled forward',
