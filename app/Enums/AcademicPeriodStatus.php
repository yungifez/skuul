...
enum AcademicPeriodStatus: string
{
    ...
    /**
     * Check if planning records may still be prepared for this period.
     *
     * Exams can be scheduled before daily work begins, but not after the
     * period enters its closing or frozen state.
     */
    public function acceptsExamPlanning(): bool
    {
        return !$this->isFrozen() && $this !== self::Closing;
    }
