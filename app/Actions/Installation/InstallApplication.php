...
class InstallApplication
{
     ...
     *     campus_postal_code?: string|null,
    ...
    public function install(array $data): Installation
    {
        ...
        return DB::transaction(function () use ($data): Installation {
            ...
            $school = School::create([
                ...
                'address' => $data['campus_address'] ?? null,
                'address_line_2' => $data['campus_address_line_2'] ?? null,
                'country' => $data['campus_country'] ?? null,
                'state' => $data['campus_state'] ?? null,
                'city' => $data['campus_city'] ?? null,
                'postal_code' => $data['campus_postal_code'] ?? null,
