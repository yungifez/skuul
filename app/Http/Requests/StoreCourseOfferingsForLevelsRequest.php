...
class StoreCourseOfferingsForLevelsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'level_ids.*' => ['integer', 'distinct', Rule::exists('academic_levels', 'id')->where('school_id', current_school_id())],
            'configurations' => ['required', 'array', 'min:1'],
            'configurations.*.academic_level_id' => ['required', 'integer', Rule::exists('academic_levels', 'id')->where('school_id', current_school_id())],
