...
class PortalOverviewController extends Controller
{
    ...
    private function openAreas(Collection $enrollments): array
    {
        ...
        foreach ($enrollments as $enrollment) {
            ...
            foreach ([PortalArea::Attendance, PortalArea::Notices, PortalArea::Calendar, PortalArea::Invoices, PortalArea::Documents, PortalArea::Boarding, PortalArea::Library, PortalArea::Requests, PortalArea::Graduation, PortalArea::Programmes] as $area) {
