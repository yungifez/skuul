...
class FeePolicy
{
    ...
    {
        if ($user->can('read fee') && $fee->feeCategory->school_id == current_school_id()) {
            return true;
        }
    }
    ...
    {
        if ($user->can('update fee') && $fee->feeCategory->school_id == current_school_id()) {
            return true;
        }
    }
    ...
    {
        if ($user->can('delete fee') && $fee->feeCategory->school_id == current_school_id()) {
            return true;
        }
    }
