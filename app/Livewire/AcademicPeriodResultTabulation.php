...
class AcademicPeriodResultTabulation extends Component
{
    ...
    public function tabulate(MyClass $myClass, $section)
    {
        ...
        $this->title = "Exam Marks For $titleFor in whole academic period ".current_academic_period()->name.' in academic year '.current_academic_year()->name;

        $examSlots = $this->academicPeriod->load('examSlots')->examSlots;
    ...
    {
        return view('livewire.academic-period-result-tabulation');
    }
}
