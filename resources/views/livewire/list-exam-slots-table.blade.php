<div class="card">
    ...
    <div class="card-body">
        <livewire:datatable  uniqueId="list-exams-table" :model="App\Models\ExamSlot::class"
        :filters="[
        ...
        :columns="[
            ...
            ['type' => 'delete', 'name' => 'Delete', 'action' => 'exam-slots.destroy', 'pre-route-parameters' => [$exam->id]]
        ]"/>
    </div>
</div>
