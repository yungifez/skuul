<div class="md:grid grid-cols-12 gap-2">
    ...
    <x-input id="admission-number" name="admission_number" label="Admission number *" placeholder="Student's admission number" group-class="col-span-6" enable-old-support autocomplete="off"/>
