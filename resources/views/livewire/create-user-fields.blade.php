<div class="md:grid grid-cols-12 gap-2 w-full">
    ...
    <x-select id="gender" name="gender" label="Gender *" group-class="col-span-3" enable-old-support>
    ...
    <x-input id="address" name="address" placeholder="{{$role}}'s address" group-class="col-span-9 no-resize" label="Address *" enable-old-support/>
