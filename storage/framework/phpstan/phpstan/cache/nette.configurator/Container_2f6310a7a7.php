...
class Container_2f6310a7a7 extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_2f6310a7a7 $container)
			{
	...
	public function createServiceContainer(): Container_2f6310a7a7
	{
		return $this;
	}
